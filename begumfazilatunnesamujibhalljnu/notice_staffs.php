...
<a href="notice_staffs.php";class="centered"id="centered">Notice Board</a></div>

 <div class="row" id="rowN" >

 <div class="card text-center">
  <div class="card-header"><h1 style="color:#175873;margin-top:1%;font-size:46px">Notice Board</h1></div>
