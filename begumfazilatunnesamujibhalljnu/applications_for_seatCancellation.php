...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
        $sql="SELECT * from seatcancellation_applications where approval_status='Waiting' order by serial desc ";
  ...
  if(isset($_POST['submit']))
   {     
    $sql="UPDATE students 
    Set previous_seatNo=seatNo, previous_roomNo=roomNo,previous_floorNo=floorNo, floorNo='0', roomNo='0', seatNo='canceled' where id= '$sid' ";
    $query=mysqli_query($conn,$sql);
    ...
    window.location.href="home_admin_without_alert.php";
    </script>'
    ;
   }
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
        $sql="SELECT * from seatcancellation_applications where approval_status='Approved' order by serial desc ";
        $query=mysqli_query($conn,$sql);
       while($info=mysqli_fetch_array($query)){  ?>
        <div class="card" style="margin-bottom:3%;">
        <div class="card-body">
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
        $sql="SELECT * from seatcancellation_applications where approval_status='Canceled' order by serial desc ";
        $query=mysqli_query($conn,$sql);
       while($info=mysqli_fetch_array($query)){  ?>
        <div class="card" style="margin-bottom:3%;">
        <div class="card-body">
