...
<body>
	...
	<form class="my-form" action="complain_staff.php" id="cStaff" method="post" enctype="multipart/form-data">
  ...
  <center> <h1><u>Begum Fazilatunnesa Mujib Hall</u></h1>
    ...
    <ul>
        ...
        <textarea id="tiny" name="staffType" disabled><?php  ?> <?php echo $query = "Designation: ".$_SESSION["staffType"] ;?> 
          <?php ?> </textarea>
        </div>
      </li>   
      <li>
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql="INSERT INTO complains_from_staff(name,id,staffType,complain,detail,result,file)
      values('$name','$id','$staffType','$complain','$detail','$result','$file')";
