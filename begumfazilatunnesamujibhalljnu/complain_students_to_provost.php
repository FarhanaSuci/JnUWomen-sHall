...
<head>
    ...
    <title>Report problem to Provost</title>
    <style>
...
<body>
	...
	<form class="my-form" action="complain_students_to_provost.php" id="cmP" method="post" enctype="multipart/form-data">
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql="INSERT INTO complains_from_students_to_provosts(name,id,floorNo,roomNo,seatNo,complain,detail,result,file)
