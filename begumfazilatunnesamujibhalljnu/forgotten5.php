...
if(isset($_POST['submit']))
{
   ...
   if($emailcount){
      ...
      //$token = $userdata['token'];
      $inresult = mysqli_query($conn,"insert into pass_reset5 values('','$email','$token')"); 

      //$subject = "";
      $body = "Hi,$name.Click here to reset your password http://localhost/WebProject/reset5.php?$token ";
