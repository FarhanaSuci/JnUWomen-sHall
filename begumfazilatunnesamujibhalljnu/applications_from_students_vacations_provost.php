...
<head>
  <meta charset="utf-8">
  <title>Applications from Students for Vacation</title>
...
<h2 style="text-align:center">Applications from Students for Vacation</h2><hr>
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
        $sql="SELECT * from students_app_vacation where approval_status='Pending' order by serial desc ";
       ...
       while($info=mysqli_fetch_array($query)){  ?>
        ...
        <div class="card-body">
         ...
         <strong>Floor no: </strong><?php echo $info['floorNo']; ?><br>
         ...
         <strong>Attached file: </strong><a target="_blank" href="file/<?php echo $info['file']; ?>">
         <?php echo $info['file']; ?></a><br>
        </p>
         </div>  
         <form class= "" action="applications_from_students_vacations_provost.php" id="responseStu" method="post">

          <input type="submit" name="submit" id="submit" class="" value="Approve">
          ...
          <input type="submit" name="cancel" id="submit" class="" value="Cancel"><br><br>
          <input type="text" name="serial" value="<?php echo $info['serial']; ?>" hidden>
  ...
  if(isset($_POST['submit']))
   {  
    ...
    $etime=$_POST['etime'];
    $sql="UPDATE students
    Set had_last_vacation_from='$stime', had_last_vacation_to='$etime' where students.id= '$sid' ";
    $query=mysqli_query($conn,$sql);
    $sql="UPDATE students_app_vacation 
    ...
    window.location.href="applications_from_students_vacations_provost.php";
    </script>'
    ;
   }
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
  include 'db_conn.php';
  $sql="SELECT * from students_app_vacation where approval_status='Approved' order by serial desc ";
  $query=mysqli_query($conn,$sql);
 while($info=mysqli_fetch_array($query)){  ?>
  <div class="card" style="margin-bottom:3%;">
  <div class="card-body">
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
include 'db_conn.php';
$sql="SELECT * from students_app_vacation where approval_status='Canceled' order by serial desc ";
$query=mysqli_query($conn,$sql);
while($info=mysqli_fetch_array($query)){  ?>
<div class="card" style="margin-bottom:3%;">
<div class="card-body">
