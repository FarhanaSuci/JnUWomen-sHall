...
<h2 style="margin-top:1.3%;color:black;margin-bottom:1%"><center>Student's Information</center></h2><hr><br>
...
{ 
$assigend_floor_no= $_SESSION['assigned_floor_no'];
$srid= $_POST['srid'];
$sql="SELECT *, count(students.id) from students where 
students.floorNo= $assigend_floor_no AND students.seatNo<>'canceled' AND  students.id='$srid' ";
$query=mysqli_query($conn,$sql);
while($info=mysqli_fetch_array($query)){  $c= $info['count(students.id)'];
if($c==1){
echo '<script type="text/JavaScript">
alert("Information for this students has been found!");
</script>';?>
<div class="col">
<div class="card h-100" style="width:98%">
  ...
  <div class="card-body">
   ...
   <br>
    ...
    <form class="" action="cancel_seat_bySB_HT.php" method="post" enctype="multipart/form-data">        
    <input type="submit" id="submit" name="submitt" value="Cancel Seat" class="btn btn-secondary" 
...
window.location.href="students_list_for_HouseTutors.php";
</script>';
}
}}
?>