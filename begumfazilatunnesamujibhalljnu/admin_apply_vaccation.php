...
<div class="containerV">
  ...
  <div class="wrapper animated bounceInLeft">
    ...
    <div class="contact">
      ...
      <form class="" action="admin_apply_vaccation.php"id="add_form_adv" method="post" enctype="multipart/form-data">
        ...
        <br>
         ...
         <input onclick="window.location.href='home_admin_without_alert.php';" type="submit" value="Cancel">
 ...
 <?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql="INSERT INTO admin_app_vacation(name,id,startTime,endTime, reason,file)
      values('$name','$id','$startTime','$endTime','$reason','$file')";
