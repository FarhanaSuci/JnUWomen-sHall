...
<body>
  <div class="slider" style="width:70%; margin-left:16% ; margin-right: 16%; margin-top:1%; margin-bottom:2%">
  <div id="carouselMaterialStyle" class="carousel slide " data-mdb-ride="carousel" >
 

  <div class="carousel-inner rounded-5 shadow-4-strong">
    <div class="carousel-item active" >
      <img src="canteeen.jpg" class="d-block w-100" alt="" style="height:507px"/>
      <div class="carousel-caption d-none d-md-block" >
        <h5 style="background-color:white; color:black">Canteen</h5>
      </div>
    </div>
    ...
    <?php
        ...
        include 'db_conn.php';
        $sql="SELECT * from slider_canteen order by serial desc";
