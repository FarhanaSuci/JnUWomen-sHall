...
<img src="club.png" alt="" style="height:480px; width:100%">
<a href="#"class="centered"style="font-size:40px;color:#3B3B3B;
 position: absolute;top:41%;left: 50%;transform: translate(-50%, -50%);">
</a>
</div>    

<h2 style="color:darkcyan;margin-top:2%"><center><u>Clubs</u></center></h2>

<div class="row row-cols-1 row-cols-md-2 g-2" style="margin-left: 20%; margin-right:14%;margin-top:2%">
 <?php
include 'db_conn.php';
$sql="SELECT * from clubs order by serial desc ";
$query=mysqli_query($conn,$sql);
while($info=mysqli_fetch_array($query)){
?>
<div class="col">
    <div class="card h-100" style="width:77%">
    <img src="image/<?php echo $info['image']; ?>"  class="card-img-top" alt="club"/>
      <div class="card-body">
        <h5 class="card-title"><?php echo $info['club_name']; ?></h5>
        <p class="card-text">
        <?php echo $info['about']; ?>
        </p>
