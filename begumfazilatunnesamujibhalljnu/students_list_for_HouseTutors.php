...
<div class="SearchBAR"style="align-content:center;margin-left:1.1%;"><?php include 'SearchBar_HT_stu.php' ?></div>
...
students.floorNo= $assigend_floor_no AND students.seatNo<>'canceled' order by students.roomNo asc ";
    ...
    <div class="card h-100" style="width:98%">
      ...
      <div class="card-body">
       ...
       <br>
        ...
        <form class="" action="students_list_for_HouseTutors.php" method="post" enctype="multipart/form-data">        
        <input type="submit" id="submit" name="submit" value="Cancel Seat" class="btn btn-secondary" 
