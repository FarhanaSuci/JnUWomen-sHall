...
<div class="nv" style="align-content:center"><?php include 'navbarAdmin.php' ?></div>
  ...
  <div class="" style=" border:2px solid black;  width:60%;
                                ...
                                margin-bottom:3%;
                                padding:2%;">
    <form class="" action="insert_achivments.php" method="post" enctype="multipart/form-data">
    

    <textarea name="achivment_name" id="tx1"  rows="20" cols="20" placeholder="Enter about achivement" required></textarea>
...
{
        $achivment_name=$_POST['achivment_name'];
        ...
        $sql="INSERT INTO achivments(achivment_name,link_read_more,image)
         values('$achivment_name','$link_read_more','$image')";
