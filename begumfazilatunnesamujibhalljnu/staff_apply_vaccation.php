...
<div class="containerV">
  ...
  <div class="wrapper animated bounceInLeft">
    ...
    <div class="contact">
      ...
      <form class="" action="staff_apply_vaccation.php"id="add_form_stv" method="post" enctype="multipart/form-data">

        <p>
          <textarea  name="name"id="name"required disabled> <?php ?> <?php echo $query = "Name: ".$_SESSION["name"] ;?> 
          <?php ?> </textarea>
        </p>
        <p>
        ...
        <p>
          <textarea name="staffType"id="staffType"required disabled><?php  ?> <?php echo $query = "Designation: ".$_SESSION["staffType"] ;?> 
          <?php ?> </textarea>
        </p>
        <br>
        <p>
        ...
        <br>
         <input  type="submit" name="submit" id="addnew"value="Submit">
         <input onclick="window.location.href='home_staff_without_alert.php';" type="submit" value="Cancel">
 ...
 <?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql="INSERT INTO staff_app_vacation(name,id,staffType,startTime,endTime, reason,file)
      values('$name','$id','$staffType','$startTime','$endTime','$reason','$file')";
     $query=mysqli_query($conn,$sql);
     echo '<script type="text/JavaScript">
     alert("Your request has been recorded!");
     window.location.href="home_staff_without_alert.php";
     </script>';
