...
<div class="containerV">
  ...
  <div class="wrapper animated bounceInLeft">
    ...
    <div class="contact">
      ...
      <form class="" action="houseTutor_apply_vaccation.php"id="add_form_htv" method="post" enctype="multipart/form-data">
        ...
        <p>
          <textarea name="assigned_floor_no"id="assigned_floor_no"required disabled><?php  ?>
           <?php echo $query = "Assigned Floor no: ".$_SESSION["assigned_floor_no"] ;?> <?php ?> </textarea>
        </p>
        <br>
        <p>
 ...
 <?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql="INSERT INTO ht_app_vacation(name,id,assigned_floor_no,startTime,endTime, reason,file)
      values('$name','$id','$assigned_floor_no','$startTime','$endTime','$reason','$file')";
