...
<head>
  <meta charset="utf-8">
  <title>Applications from House-tutors for Vacation</title>
...
<h2 style="text-align:center">Applications from House-tutors for Vacation</h2><hr>
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
        $sql="SELECT * from ht_app_vacation where approval_status='Pending' order by serial desc ";
       ...
       while($info=mysqli_fetch_array($query)){  ?>
        ...
        <div class="card-body">
         ...
         <form class= "" action="applications_from_ht_vacations_provost.php" method="post">
  ...
  if(isset($_POST['submit']))
   {   
    ...
    window.location.href="applications_from_ht_vacations_provost.php";
    </script>'
    ;
   }
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
  include 'db_conn.php';
  $sql="SELECT * from ht_app_vacation where approval_status='Approved' order by serial desc ";
  $query=mysqli_query($conn,$sql);
 while($info=mysqli_fetch_array($query)){  ?>
  <div class="card" style="margin-bottom:3%;">
  <div class="card-body">
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
include 'db_conn.php';
$sql="SELECT * from ht_app_vacation where approval_status='Canceled' order by serial desc ";
$query=mysqli_query($conn,$sql);
while($info=mysqli_fetch_array($query)){  ?>
<div class="card" style="margin-bottom:3%;">
<div class="card-body">
