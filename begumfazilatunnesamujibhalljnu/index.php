...
<div class="nv" style="align-content:center;"><?php include 'navbar.php' ?></div>
...
echo $intro_show; ?><br>
<a target="_blank" href="introduction.php"
 class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Read more</a>
 ...
 <div class="row g-0">
  <div class="col-md-4">
   ...
   margin-left:11%; margin-top:11%"/>
    ...
    <a target="_blank" href="current_provost.php" class="btn btn-info  btn-lg" style="margin-left:27%">Details</a></h5>
    </div>
    <div class="col-md-8"><div class="card-body" style="margin-top:2%">
     <h4 class="card-title">Message from Provost</h4><hr>
      ...
      <?php 
        ...
        <a target="_blank" href="messageProvost.php" class="btn btn-info">Read full message</a>       
      </div>
    </div>
  </div>
</div>
...
<h2 style="color:#0a7e8c"><center>Notice</center></h2><hr>

  <div class="ntc">
  <?php include 'noticeHome.php' ?>
...
<div class="row" style="margin-top:5% ;margin-bottom:2% ;margin-left:10% ;margin-right:10%;">
<h2 style="color:#0a7e8c"><center>Facilities</center></h2><hr>
  ...
  <div class="col">
    ...
    <img src="image/<?php echo $info['image']; ?>"  class="card-img-top" style="height: 67%;" alt="facility"/>
      <div class="card-body">
        ...
        <a target="_blank" href="facilities.php" class="btn btn-secondary">View Detail</a>
</div>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    ...
    <img src="image/<?php echo $info['image']; ?>"  class="card-img-top" style="height: 67%;" alt="club"/>
      <div class="card-body">
        ...
        <div class="card-footer" style="margin-bottom:1%"> 
        <a target="_blank" href="clubs.php" class="btn btn-secondary">View Detail</a>
</div>
      </div></div></div>
<?php
}
...
<?php include 'gallery_for_homepage.php' ?>
  ...
  <center><a target="_blank" href="gallery.php" class="btn btn-lg btn-info" style=" width:26%;font-size:medium;text-align:center ">
  View all photos</a></center>
</div>
