 ...
 <div class="row g-0">
  <div class="col-md-4">
   ...
   margin-left:11%; margin-top:11%"/>
    ...
    <a href="current_provost_for_staffs.php" class="btn btn-info  btn-lg" style="margin-left:27%">Details</a></h5>
    </div>
    <div class="col-md-8"><div class="card-body" style="margin-top:2%">
     <h4 class="card-title">Message from Provost</h4><hr>
      ...
      <?php 
        ...
        <a href="messageProvost_staffs.php" class="btn btn-info">Read full message</a>    
       </div>
    </div>
  </div>
</div>
