...
<div class="row row-cols-1 row-cols-md-3 g-4" style="margin-left: 11.5%;margin-right:10%;margin-bottom:3%;margin-top:1%">
<?php
include 'db_conn.php';
 ...
 <div class="col">
    <div class="card h-100" style="width:98%">
      ...
      <div class="card-body">
        ...
        <?php echo $info['house_tutor_designation']; ?><br>
        <p class="card-text">
