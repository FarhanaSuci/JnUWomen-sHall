...
<html lang="en" dir="ltr">
 <head>
    <meta charset="utf-8">
    <title>Insert image in Slider</title>
...
<?php include 'navbarAdmin.php' ?>
 ...
 <div class="" style=" border:2px solid black;
                                ...
                                margin-top:50px;
                                padding:2%;" >
                <form class="" action="insert_in_slider.php" method="post" enctype="multipart/form-data">
...
if(isset($_POST['submit']))
{
        ...
        $sql="INSERT INTO slider(caption,image) values('$caption','$image')";
        $query=mysqli_query($conn,$sql);
        echo '<script type="text/JavaScript">
        alert("A new image has been added in carousel.");
