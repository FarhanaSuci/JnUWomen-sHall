...
<head>
    ...
    <title>Report problem to House tutor</title>
    <style>
...
<body>
	...
	<form class="my-form" action="complain_from_students_for_houseTutors.php" id="cmStu" method="post" enctype="multipart/form-data">
  ...
  <center> <h1><u>Begum Fazilatunnesa Mujib Hall</u></h1>
    ...
    <ul>
       ...
       <textarea id="tiny" name="floorNo" disabled><?php  ?> <?php echo $query = "Floor no: ".$_SESSION["floorNo"] ;?> 
          <?php ?> </textarea>      
        <textarea id="tiny" name="roomNo" disabled><?php  ?> <?php echo $query = "Room no: ".$_SESSION["roomNo"] ;?> 
          <?php ?> </textarea>
        <textarea id="tiny" name="seatNo" disabled><?php  ?> <?php echo $query = "seat no: ".$_SESSION["seatNo"] ;?> 
          <?php ?> </textarea>
        </div>
       </li>
      ...
      <li>
      <input id="complain" name="complain" type="text" placeholder="Enter your complain headline"required>
      </li>  
      <li>
        <textarea id="big" type="text"name="detail"placeholder="Explain your complain in detail"></textarea>
      </li>   
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $sql="INSERT INTO complains_from_students_to_housetutor(name,id,floorNo,roomNo,seatNo,complain,detail,result,file)
      values('$name','$id','$floorNo','$roomNo','$seatNo','$complain','$detail','$result','$file')";
