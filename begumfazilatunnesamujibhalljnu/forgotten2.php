...
if(isset($_POST['submit']))
{
   ...
   $emailquery = "select * from current_provost where email = '$email'";
   ...
   if($emailcount){
      ...
      //$token = $userdata['token'];
      $inresult = mysqli_query($conn,"insert into pass_reset2 values('','$email','$token')"); 

      //$subject = "";
      $body = "Hi,$name.Click here to reset your password http://localhost/WebProject/reset2.php?$token ";
