...
students.seatNo<>'canceled' AND  students.id='$srid' ";
...
<div class="card h-100" style="width:98%">
  ...
  <div class="card-body">
   ...
   <br>
    ...
    <form class="" action="cancel_seat_bySB_admin.php" method="post" enctype="multipart/form-data">        
...
window.location.href="student_list_admin.php";
</script>';
}
}}
?>