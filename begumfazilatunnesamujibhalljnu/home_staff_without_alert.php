...
<div class="row" style="padding-bottom:2% ;margin-left:10% ;margin-right:10%;padding-top:3%">
...
?>
<p style="font-size:15px;color:black;margin-left:0%;margin-right:90%;margin-top:1%;
text-align:justify;white-space:pre-line">
<?php 
$intro=$info['intro'];
$intro_show=substr($intro,0,5024)."...";
echo $intro_show; ?><br>
<a href="introduction_Staffs.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Read more</a>
...
<div class="row" style="margin-top:3% ;margin-bottom:2% ;margin-left:10% ;margin-right:10%;">
 ...
 <div class="row g-0">
  <div class="col-md-4">
   ...
   margin-left:11%; margin-top:11%"/>
    ...
    <a target="_blank" href="current_provost_for_staffs.php" class="btn btn-info  btn-lg" style="margin-left:27%">Details</a></h5>
    </div>
    <div class="col-md-8"><div class="card-body" style="margin-top:2%">
     <h4 class="card-title">Message from Provost</h4><hr>
      ...
      <?php 
        ...
        <a target="_blank" href="messageProvost_staffs.php" class="btn btn-info">Read full message</a>    
       </div>
    </div>
  </div>
</div>
...
<div class="row" style="padding-top:5% ;padding-bottom:2% ;margin-left:10% ;margin-right:10%;">

  <div class="ntc">
  <?php include 'noticeHome_staff.php' ?>
...
<div class="card text-center">
  ...
  <div class="card-footer" style="padding-bottom:1%"></div>
</div>
</p>
</div>
  ...
  <div class="col">
    ...
    <img src="image/<?php echo $info['image']; ?>"  class="card-img-top" style="height: 67%;" alt="facility"/>
      <div class="card-body">
        ...
        <a target="_blank" href="facilities_staffs.php" class="btn btn-secondary">View Detail</a>
</div>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    ...
    <img src="image/<?php echo $info['image']; ?>"  class="card-img-top" style="height: 67%;" alt="club"/>
      <div class="card-body">
        ...
        <div class="card-footer" style="margin-bottom:1%"> 
        <a target="_blank" href="clubs_staffs.php" class="btn btn-secondary">View Detail</a>
</div>
      </div>
    </div>
  </div>
...
<?php include 'gallery_for_homepage.php' ?>
  ...
  <center><a target="_blank" href="gallery_staff.php" class="btn btn-lg btn-info" style=" width:16%; ">View all photos</a></center>
</div>
