...
if(isset($_POST['submit']))
{
   ...
   $emailquery = "select * from current_house_tutors where email = '$email'";
   ...
   if($emailcount){
      ...
      //$token = $userdata['token'];
      $inresult = mysqli_query($conn,"insert into pass_reset3 values('','$email','$token')"); 

      //$subject = "";
      $body = "Hi,$name.Click here to reset your password http://localhost/WebProject/reset3.php?$token ";
