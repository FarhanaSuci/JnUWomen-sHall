...
<?php include 'navbarAdmin.php' ?>
  ...
  <div class="" style=" border:2px solid black;   width:52%;
                                ...
                                margin-bottom:3%;
                                padding:2%;">
    <form class="" action="insert_news.php" method="post" enctype="multipart/form-data">
    <textarea name="headline" id="tx1"  rows="20" cols="20" placeholder="Enter headline" required></textarea>
    <textarea name="news" id="tx2"  rows="20" cols="20" placeholder="Enter News" required></textarea><br><br>
...
if(isset($_POST['submit']))
{
       $headline=$_POST['headline'];
        ...
        $sql="INSERT INTO news(headline,news,image) values('$headline','$news','$image')";
        $query=mysqli_query($conn,$sql);
        echo '<script type="text/JavaScript">
        alert("A new news has been published.");
