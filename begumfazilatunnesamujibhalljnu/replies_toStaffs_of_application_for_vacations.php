 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
      $id=$_SESSION['id'];
        $sql="SELECT * from staff_app_vacation where approval_status='Pending' AND id='$id' order by serial desc ";
       ...
       while($info=mysqli_fetch_array($query)){  ?>
        ...
        <div class="card-body">
         ...
         <form class= "" action="replies_toStaffs_of_application_for_vacations.php" method="post">
  ...
  if(isset($_POST['cancel']))   {     
    $serial=$_POST['serial']; 
    $sql="DELETE FROM staff_app_vacation 
    where serial= '$serial' ";
    $query=mysqli_query($conn,$sql);
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  include 'db_conn.php';
  $id=$_SESSION['id'];
  $sql="SELECT * from staff_app_vacation where approval_status='Approved'  AND id='$id' order by serial desc ";
  $query=mysqli_query($conn,$sql);
 while($info=mysqli_fetch_array($query)){  ?>
  <div class="card" style="margin-bottom:3%;">
  <div class="card-body">
...
include 'db_conn.php';
$id=$_SESSION['id'];
$sql="SELECT * from staff_app_vacation where approval_status='Canceled'  AND id='$id' order by serial desc ";
$query=mysqli_query($conn,$sql);
while($info=mysqli_fetch_array($query)){  ?>
<div class="card" style="margin-bottom:3%;">
<div class="card-body">
