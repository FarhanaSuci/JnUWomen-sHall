...
echo $intro_show; ?><br>
<a href="introduction_HouseTutors.php" 
 ...
 <div class="row g-0">
  <div class="col-md-4">
   ...
   margin-left:11%; margin-top:11%"/>
    ...
    <a target="_blank" href="current_provost_for_houseTutors.php" class="btn btn-info  btn-lg" style="margin-left:26%">Details</a>
</div>
    <div class="col-md-8"><div class="card-body" style="margin-top:2%">
     <h4 class="card-title">Message from Provost</h4><hr>
      ...
      <?php 
        ...
        <a href="messageProvost_houseTutors.php" class="btn btn-info">Read full message</a>
...
<div class="row" style="margin-top:5% ;margin-bottom:2% ;margin-left:10% ;margin-right:10%;">
  <div class="ntc">
  <?php include 'noticeHome_houseTutor.php' ?>
  ...
  <div class="col">
    ...
    <img src="image/<?php echo $info['image']; ?>"  class="card-img-top" style="height: 67%;" alt="facility"/>
      <div class="card-body">
        ...
        <a target="_blank" href="facilities_houseTutors.php" class="btn btn-secondary">View Detail</a>
</div>
      </div>
    </div>
  </div>
  ...
  <div class="col">
    ...
    <img src="image/<?php echo $info['image']; ?>"  class="card-img-top" style="height: 67%;" alt="club"/>
      <div class="card-body">
        ...
        <div class="card-footer" style="margin-bottom:1%"> 
        <a target="_blank" href="clubs_houseTutors.php" class="btn btn-secondary">View Detail</a>
</div>
      </div>
    </div>
  </div>
...
<?php include 'gallery_for_homepage.php' ?>
  ...
  <center><a target="_blank" href="gallery_house_tutor.php" class="btn btn-lg btn-info" style=" width:16%; ">View all photos</a></center>
</div>
