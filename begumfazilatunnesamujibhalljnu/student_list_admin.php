...
<div class="SearchBAR"style="align-content:center;margin-left:1.1%;"><?php include 'SearchBar_admin_stu.php' ?></div>

<div class="row row-cols-1 row-cols-md-3 g-4" style="margin-left: 12%;margin-right:10%;margin-bottom:3%;margin-top:1%">
<?php
include 'db_conn.php';
$sql="SELECT * from students where floorNo<>'0' order by floorNo asc ";
      ...
      <div class="card-body">
       ...
       <br>
        ...
        <ul class="list-group list-group-light list-group-small">
          ...
          <li class="list-group-item"><b>Id: </b><?php echo $info['id']; 
          $sid=$info['id'];?></li>
