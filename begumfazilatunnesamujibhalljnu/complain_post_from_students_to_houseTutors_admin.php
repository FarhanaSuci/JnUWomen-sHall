...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
      $sql="SELECT * from complains_from_students_to_housetutor where response_status='Pending' order by serial desc ";
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
  include 'db_conn.php';
  $sql="SELECT * from complains_from_students_to_housetutor where response_status='Approved' order by serial desc ";
  $query=mysqli_query($conn,$sql);
 while($info=mysqli_fetch_array($query)){  ?>
  <div class="card" style="margin-bottom:3%;">
  <div class="card-body">
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
include 'db_conn.php';
$sql="SELECT * from complains_from_students_to_housetutor where response_status='Canceled' order by serial desc ";
$query=mysqli_query($conn,$sql);
while($info=mysqli_fetch_array($query)){  ?>
<div class="card" style="margin-bottom:3%;">
<div class="card-body">
