...
<head>
  <meta charset="utf-8">
  <title>Complains from Staffs</title>
...
<h2 style="text-align:center">Complains from Staffs</h2><hr>
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
      include 'db_conn.php';
      $sql="SELECT * from complains_from_staff where response_status='Pending' order by serial desc ";
      $query=mysqli_query($conn,$sql);
     while($info=mysqli_fetch_array($query)){  ?>
      <div class="card" style="margin-bottom:3%;">
      <div class="card-body">
       <h5 class="card-title"><strong> Complain Id: </strong><?php echo $info['serial']; ?><br>
       ...
       <strong>Desired Outcome: </strong><?php echo $info['result']; ?><br>
         ...
         <form class= "" action="complain_post_from_staffs_provost.php" method="post">
  ...
  if(isset($_POST['submit']))
   {
    $serial=$_POST['serial'];            
    $sql="UPDATE `complains_from_staff` 
    SET `response_status` = 'Approved' WHERE `complains_from_staff`.`serial`= '$serial' ";
    $query=mysqli_query($conn,$sql);
    echo '<script type="text/JavaScript">
    alert("This complain has been proven and the actions are taken!");
    window.location.href="complain_post_from_staffs_provost.php";
    </script>'
    ;
   }
   ...
   else if(isset($_POST['cancel']))
   {
    $serial=$_POST['serial'];            
    $sql="UPDATE  `complains_from_staff` 
    SET `response_status`='Canceled' WHERE `complains_from_staff`.`serial`= '$serial' ";
    $query=mysqli_query($conn,$sql);
    echo '<script type="text/JavaScript">
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
  include 'db_conn.php';
  $sql="SELECT * from complains_from_staff where response_status='Approved' order by serial desc ";
  $query=mysqli_query($conn,$sql);
 while($info=mysqli_fetch_array($query)){  ?>
  <div class="card" style="margin-bottom:3%;">
  <div class="card-body">
...
<div class="card-body">
 ...
 <div class="col-md-3">
  ...
  <div class="divmain">
   <?php
include 'db_conn.php';
$sql="SELECT * from complains_from_staff where response_status='Canceled' order by serial desc ";
$query=mysqli_query($conn,$sql);
while($info=mysqli_fetch_array($query)){  ?>
<div class="card" style="margin-bottom:3%;">
<div class="card-body">
